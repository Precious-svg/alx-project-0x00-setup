    ...
    return (
      <div>
        ...
        <main className="p-8 flex flex-wrap gap-4">
           ...
           <Button title="Small Rounded-full" styles="px-3 py-1 text-sm rounded-full bg-purple-500 text-white" />
           ...
           <Button title="Medium Rounded-full" styles="px-4 py-2 text-base rounded-full bg-purple-600 text-white" />
           ...
           <Button title="Large rounded-full" styles="px-6 py-3 text-lg rounded-full bg-purple-700 text-white" />
      </main>
